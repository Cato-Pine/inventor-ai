...
import { ArrowLeft, Send, Lightbulb, User, Loader2 } from 'lucide-react'
...
export default function ChatPage({ params }: ChatPageProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      <Header title={`AI Assistant${project ? ` - ${project.name}` : ''}`} />
            ...
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <p className="text-muted-foreground max-w-md mb-6">
                  I can help you validate your invention idea, identify target
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full max-w-lg">
                  {[
                    ...
                    'What questions should I ask to validate my idea?',
                    'How do I find communities where my audience hangs out?',
                    'What are the key pain points I should research?',
                  ].map((suggestion) => (
                    <Button
                      key={suggestion}
                      variant="outline"
          ...
          <CardContent className="border-t p-4">
            <div className="flex gap-2">
              <Textarea
                ...
                placeholder="Ask me anything about your invention..."
